  ...
  return (
    <div className=" w-[100%] bg-[#0d0f10e6] text-white items-center flex flex-col sm:flex-row justify-between px-8 py-14">
        <div className=" overflow-hidden relative z-50">
          <a href="#home" className="text-white text-[1.5rem] hover:text-[#842cd7] transition-colors">Axl Design<span className="text-[#842cd7]">.</span></a><p className="text-white/60">By Joseph Vásquez</p>
        </div>
